...
import { AppsFileManagamentRoutingModule } from './apps.filemanagement-routing.module';
...
@NgModule({
  ...
  declarations: [AppsFileManagementComponent, FolderComponent, CardComponent, UploadFilesComponent, ChartComponent],
