...
export class AppOrderDetailsComponent {
    ...
    ngOnInit(): void {
      ...
      this.events = [
        {status: 'Ordered', date: '15/04/2022 10:30', completed: true},
        {status: 'Processing', date: '20/04/2022 14:00', completed: true},
        {status: 'Shipped', date: '20/04/2022 16:15', completed: false},
        {status: 'Delivered', date: '22/04/2022 10:00', completed: false}
      ];
    }
}
